...
# Replace standard _logger with our custom _logger
...
def from_anthropic(schema: Dict[str, Any]) -> Type[Schema]:
    ...
    try:
        ...
        _logger.debug(f"Successfully converted Anthropic schema to belso schema with {len(ConvertedSchema.fields)} fields.")
