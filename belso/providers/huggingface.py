...
def to_huggingface(schema: Type[Schema]) -> Dict[str, Any]:
    ...
    try:
        ...
        _logger.debug("Successfully created Hugging Face schema.")
...
def from_huggingface(schema: Dict[str, Any]) -> Type[Schema]:
    ...
    try:
        ...
        _logger.debug(f"Successfully converted Hugging Face schema to belso schema with {len(ConvertedSchema.fields)} fields.")
