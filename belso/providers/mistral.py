...
from belso.utils.constants import _MISTRAL_FIELD_MAP
...
def _convert_field_to_property(field: BaseField) -> Dict[str, Any]:
    """
    Converts a base field into a property definition for Mistral.\n
    ---
    ### Args
    - `field` (`belso.core.BaseField`): the field to convert.\n
    ---
    ### Returns
    - `Dict[str, Any]`: the property definition.\n
    """
    base_property = {
        "type": map_python_to_json_type(getattr(field, "type_", str)),
        "description": field.description
    }
    for attr, mappings in _MISTRAL_FIELD_MAP.items():
...
def _convert_nested_field(field: NestedField) -> Dict[str, Any]:
    """
    Converts a nested field into a property definition for Mistral.\n
    ---
    ### Args
...
def _convert_array_field(field: ArrayField) -> Dict[str, Any]:
    """
    Converts an array field into a property definition for Mistral.\n
    ---
    ### Args
...
def to_mistral(schema: Type[Schema]) -> Dict[str, Any]:
    """
    Converts a schema to a JSON schema.\n
    ---
    ### Args
